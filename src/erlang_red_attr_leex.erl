...
yystate(12, [10|Ics], Line, _, Tlen, _, _) ->
    yystate(12, Ics, Line+1, 1, Tlen+1, 0, Tlen);
yystate(12, Ics, Line, Col, Tlen, _, _) ->
    {0,Tlen,Ics,Line,Col,12};
...
yystate(10, [46|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(7, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 11, C =< 38 ->
    yystate(3, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(7, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 40 ->
    yystate(3, Ics, Line, Col, Tlen+1, Action, Alen);
