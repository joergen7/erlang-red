...
start(NodePid, Wires, Cmd, Msg, Opts) ->
    ...
    %% with a single user - I know, no need to point nor shake fingers at me.
    %% I understand the risk and also accept it - others might well not.
    %% TODO should be moved to the app specification and be started with the
    %% TODO application
