...
-file("/code/src/jsonata_parser.yrl", 53).
...
-file("/code/src/jsonata_parser.erl", 217).
...
yeccpars2_5(S, 'chars', Ss, Stack, T, Ts, Tzr) ->
    yeccpars1(S, 8, Ss, Stack, T, Ts, Tzr);
yeccpars2_5(S, 'msg_obj', Ss, Stack, T, Ts, Tzr) ->
...
yeccgoto_args(5, Cat, Ss, Stack, T, Ts, Tzr) ->
...
-file("/code/src/jsonata_parser.yrl", 40).
...
-file("/code/src/jsonata_parser.yrl", 39).
...
-file("/code/src/jsonata_parser.yrl", 37).
...
-file("/code/src/jsonata_parser.yrl", 38).
...
-file("/code/src/jsonata_parser.yrl", 30).
