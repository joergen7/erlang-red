...
-file("/code/src/jsonata_parser.erl", 3).
-export([parse/1, parse_and_scan/1, format_error/1]).
-file("/code/src/jsonata_parser.yrl", 42).
...
-file("/code/src/jsonata_parser.erl", 197).
...
yeccgoto_assignment(0, Cat, Ss, Stack, T, Ts, Tzr) ->
    yeccpars2_3(3, Cat, Ss, Stack, T, Ts, Tzr);
yeccgoto_assignment(3, Cat, Ss, Stack, T, Ts, Tzr) ->
    yeccpars2_3(3, Cat, Ss, Stack, T, Ts, Tzr).

-dialyzer({nowarn_function, yeccgoto_assignments/7}).
-compile({nowarn_unused_function, yeccgoto_assignments/7}).
yeccgoto_assignments(0 = _S, Cat, Ss, Stack, T, Ts, Tzr) ->
    yeccpars2_2(_S, Cat, Ss, Stack, T, Ts, Tzr);
yeccgoto_assignments(3 = _S, Cat, Ss, Stack, T, Ts, Tzr) ->
    yeccpars2_17(_S, Cat, Ss, Stack, T, Ts, Tzr).
...
yeccgoto_expr(12 = _S, Cat, Ss, Stack, T, Ts, Tzr) ->
    yeccpars2_13(_S, Cat, Ss, Stack, T, Ts, Tzr).
...
-file("/code/src/jsonata_parser.yrl", 24).
...
-file("/code/src/jsonata_parser.yrl", 26).
...
-file("/code/src/jsonata_parser.yrl", 29).
...
-file("/code/src/jsonata_parser.yrl", 32).
...
-file("/code/src/jsonata_parser.yrl", 31).
...
-file("/code/src/jsonata_parser.yrl", 36).
...
-file("/code/src/jsonata_parser.yrl", 34).
...
-file("/code/src/jsonata_parser.yrl", 33).
...
-file("/code/src/jsonata_parser.yrl", 35).
...
-file("/code/src/jsonata_parser.yrl", 27).
yeccpars2_17_(__Stack0) ->
    [___2, ___1 | __Stack] = __Stack0,
    [
        begin
            lists:merge(___1, ___2)
        end
        | __Stack
    ].

-file("/code/src/jsonata_parser.yrl", 45).
