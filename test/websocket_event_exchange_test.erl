...
ensure_unsubscribe_is_working_test() ->
    ...
    ?assertEqual(#{status => #{wsname => #{nodeid => [cb1234]}},debug => #{}},
    ...
    websocket_event_exchange:subscribe(wsname,anothernodeid,debug,
                                       warning,cb1234),
    websocket_event_exchange:subscribe(anotherwsname,anothernodeid,debug,
                                       warning,cb1234),
    ...
    ?assertEqual( #{status => #{anotherwsname => #{nodeid => [cb4321,cb1234]}},
                   debug =>
                       #{anotherwsname =>
                             #{anothernodeid =>
                                   [{warning,cd4321},{warning,cb1234}]}}},
